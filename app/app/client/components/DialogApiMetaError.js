/**
 * DialogApiMetaError.js COPYRIGHT FUJITSU LIMITED 2021
 */
 ...
 * @extends React
 */
export default class DialogApiMetaError extends React.Component {
  /**
  * Dialog Close Event
  */
  handleClose() {
   ...
   */
  render() {
    const apiErrorDialog = this.props.editingVocabularyMeta.apiErrorDialog;
    let errCode = '';
