  ...
  */
  ...
  @action updataSynonym(newValue) {
    ...
    newValue.forEach((term)=>{
      ...
      langDiffFilters.forEach((node)=>{ newLangDiffValue.push(node.term) });
    });
