...
def hensyugoi(tuning, hensyugoi_file, vec, syn, hyper, filter_words, domain_words_file, voc_uri):
    ...
    with open(hensyugoi_file, 'w', newline="", errors='ignore', encoding='utf-8-sig') as f:
        ...
        for index, word in enumerate(filter_words):
            ...
            color2 = domain_words_csv["色2"][index] if flag_color2 else "white"
...
def main(args, config):
    vec_file = args.input[0]
    syn_file = args.input[1]
    hyper_file = args.input[2]
