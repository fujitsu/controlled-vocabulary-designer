  ...
  getErrorMessage(){
    ...
    switch (this.props.reason.errorKind) {
      ...
      case 'multiPreferredLabel':
        errorMsgEdt = '代表語テキストボックスには、複数の用語を記入できません。¥n' + '用語を1つだけ記入してください。';
        errorMsgVoc = '代表語は、複数の用語を設定できません。' ;
        break;
      ...
      case 'invalidPreferredLabel':
        ...
        if(term !==''){
          errorMsgEdt =  '代表語テキストボックスに記入された用語は、¥n' +
            '「' + term + '」 または同義語のいずれにも含まれていません。¥n' +
            '代表語テキストボックスには、¥n' +
            '「' + term +'」 または同義語の中から一つ選んで記入してください。';
          errorMsgVoc = '代表語に設定された用語は、¥n' +
           '「' + term + '」 または同義語のいずれにも含まれていません。¥n' +
           '代表語には、¥n「' + term +'」 または同義語の中から一つ選んで設定してください。';
        }else{
          errorMsgEdt =  '代表語テキストボックスに記入された用語は、¥n' +
            '同義語のいずれにも含まれていません。¥n' +
            '代表語テキストボックスには、¥n' +
      ...
      case 'narrowerSynonym':
        errorMsgEdt = '同義語テキストボックスに、 下位語が記入されています。¥n' +
      ...
      case 'multiBroaderTerm':
        errorMsgEdt = '上位語テキストボックスには、複数の用語を記入できません。¥n用語を1つだけ記入してください。';
        errorMsgVoc = '上位語には、複数の用語を設定できません。';
        break;
      ...
      case 'broaderInSynonym':
        if(term !==''){
          errorMsgEdt = '上位語テキストボックスに、¥n' +
            ...
            '上位語テキストボックスには、¥n' +
            '「' + term + '」 もしくは同義語ではない用語を記入してください。';
          errorMsgVoc = '上位語に、¥n' +
           '「' + term + '」 あるいは同義語が設定されています。¥n' +
           '上位語には、¥n' +
           '「' + term + '」 もしくは同義語ではない用語を設定してください。';
        }else{
          errorMsgEdt = '上位語テキストボックスに、¥n' +
            '同義語が記入されています。¥n' +
            '上位語テキストボックスには、¥n' +
    ...
    const langTitleDisableArr = ['blankPreferredLabel'].includes(this.props.reason.errorKind);
    const langStr = langTitleDisableArr?'':'【'+(this.props.reason.language=='ja'?'日本語':'英語')+'の用語について】¥n';    
